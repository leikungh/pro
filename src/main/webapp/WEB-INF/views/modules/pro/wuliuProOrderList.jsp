...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/pro/proOrder/wllist">物流列表</a></li>
		
	</ul>
	<form:form id="searchForm" modelAttribute="proOrder" action="${ctx}/pro/proOrder/wllist" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="proOrder">
			<tr>
				<td><a href="${ctx}/pro/proOrder/wlform?id=${proOrder.id}">
					${proOrder.code}
				</a></td>
				<td>
				...
				<shiro:hasPermission name="pro:proOrder:edit"><td>
					...
					<a href="${ctx}/pro/proOrder/wldelete?id=${proOrder.id}" onclick="return confirmx('确认要删除该订单吗？', this.href)">删除</a>
