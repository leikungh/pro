...
<body>
	<form:form id="inputForm" modelAttribute="proOrder" action="${ctxAddOrder}/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			...
			<a href="#" id="btnCancel" class="btn" type="button" onclick="javascript:window.close()"><button>返回</button></a>
		</div>
	</form:form>
</body>
</html>