...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/pro/proOrder/list2">订单列表</a></li>
		<li class="active"><a href="${ctx}/pro/proOrder/finishForm?id=${proOrder.id}">订单<shiro:hasPermission name="pro:proOrder:edit">${not empty proOrder.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="pro:proOrder:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="proOrder" action="${ctx}/pro/proOrder/wlsave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
